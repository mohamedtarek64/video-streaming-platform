        ...
        <div class="max-w-[1700px] mx-auto px-4 md:px-8 mt-4">
            ...
            <div class="mt-8 flex flex-col md:flex-row items-center md:items-end gap-6 px-4">
                ...
                <div class="flex gap-3 mb-2">
                    <button class="bg-indigo-600 text-white px-8 py-2.5 rounded-full font-black hover:bg-indigo-700 transition shadow-lg shadow-indigo-600/30">Subscribe</button>
